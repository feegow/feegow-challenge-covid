            ...
            <div class="card-body">
                <form action="../../controller/GerenciamentoController.php" method="POST">
                    ...
                    <div class="form-group" style="margin-top: 10px;">
                        ...
                        <input class="form-control" type="date" placeholder="d/m/YYYY" name="data_nascimento" required>
                    </div>

                    <div class="form-group" style="margin-top: 10px;">
                        <label>Data da Primeira Dose:</label>
                        <input class="form-control" type="date" placeholder="d/m/YYYY" name="data_primeira_dose" required>
                    </div>

                    <div class="form-group" style="margin-top: 10px;">
                        <label>Data da Segunda Dose:</label>
                        <input class="form-control" type="date" placeholder="d/m/YYYY" name="data_segunda_dose" required>
                    </div>

                    <div class="form-group" style="margin-top: 10px;">
                        <label>Data da Terceira Dose:</label>
                        <input class="form-control" type="date" placeholder="d/m/YYYY" name="data_terceira_dose" required>
                    </div>
                    ...
                    <div class="form-group" style="margin-top: 10px;">
                        <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault" name="has_comorbidade">
